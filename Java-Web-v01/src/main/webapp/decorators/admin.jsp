...
<title>Trang chủ</title>
  ...
  <link href="<c:url value='/template/admin/css/sb-admin.css" rel="stylesheet' />" rel="stylesheet" type="text/css">
...
<script src="<c:url value='/template/admin/js/sb-admin.min.js'/>"></script>
  ...
  <script src="<c:url value='/template/admin/vendor/bootstrap/js/demo/chart-area-demo.js'/>"></script>
